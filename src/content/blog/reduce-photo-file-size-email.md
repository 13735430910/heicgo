---
title: "How to Reduce Photo File Size for Email (Under 10 MB)"
description: "Email attachment limits blocking your photos? Learn 5 ways to shrink photo file sizes below 10 MB without visible quality loss."
publishDate: 2025-05-19
tags: ["email", "compression", "tutorial", "sharing"]
---

Most email providers cap attachments at 25 MB (Gmail) or 10 MB (Outlook). A single iPhone photo can be 5-8 MB as JPEG, making it impossible to attach more than 2-3 photos. Here's how to fix that.

## Why Photos Are Too Large for Email

A typical 12 MP iPhone photo:

| Format | Quality | File Size | Emailable? |
|--------|---------|-----------|:--:|
| HEIC | Original | ~2.5 MB | Yes |
| JPEG | 100% | ~8 MB | 1-2 photos max |
| JPEG | 92% | ~4 MB | Yes |
| JPEG | 85% | ~2.5 MB | Yes, recommended |
| JPEG | 70% | ~1.5 MB | Yes, ideal |
...
## Method 4: Use Cloud Sharing Links
